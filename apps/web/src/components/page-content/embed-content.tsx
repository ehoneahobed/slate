...
export function CodeEmbedBody({
  ...
  return (
    <div
      className={`flex min-h-0 flex-1 flex-col overflow-hidden rounded-b-xl border border-t-0 border-[color-mix(in_oklch,var(--ink)_18%,var(--chrome-b))] bg-[#1c1a17] text-[#f2efe6] shadow-[inset_0_1px_0_rgba(255,255,255,.04)] ${rootClassName}`.trim()}
    >
      <div className="flex shrink-0 items-center gap-2 border-b border-white/10 bg-[#2c2924] px-2.5 py-1.5">
      ...
      <pre className="min-h-0 flex-1 overflow-auto whitespace-pre p-3 font-mono text-[11px] leading-relaxed text-[#e8e4dc]">{code}</pre>
    </div>
  );
}
